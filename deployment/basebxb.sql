...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'port', '44041', 'int', 'Monero Daemon RPC Port');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'activePort', '44041', 'int', 'Currently active daemon RPC port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'port', '44042', 'int', 'Monero Daemon RPC Wallet Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'pplnsFee', '.01', 'float', 'Fee charged for the usage of the PPLNS pool');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'exchangeMin', '20', 'float', 'Minimum XMR balance for payout to exchange/payment ID');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'sigDivisor', '10000', 'int', 'Divisor for turning coin into human readable amounts ');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feesForTXN', '0', 'int', 'Amount of XMR that is left from the fees to pay miner fees.');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'maxTxnValue', '100', 'int', 'Maximum amount of XMR to send in a single transaction');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'coinCode', 'BXB', 'string', 'Coincode to be loaded up w/ the shapeshift getcoins argument.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'mixIn', '1', 'int', 'Mixin count for coins that support such things.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewAmount', '.005', 'float', 'Amount to charge for the txn fee');
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewEnd', '200', 'float', 'Value at which txn fee amount drops to 0');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'emailSig', 'HashCrypto.Pro BLOC Admin', 'string', 'Signature line for the emails.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'fee', '2', 'int', 'Atomic units of coin to use ass a fee');
...
INSERT INTO pool.port_config (poolPort, difficulty, portDesc, portType, hidden, `ssl`) VALUES (8888, 400000, 'Nicehash and Mnining Rig Rentals', 'pplns', 0, 0);
